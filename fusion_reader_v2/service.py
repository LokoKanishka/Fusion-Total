...
class FusionReaderV2:
    ...
    def veil_catalog(self) -> list[dict]:
        return [
            ...
            {"mode": "bar_filosofico", "label": "Bar filosófico", "description": "Hablalo como una discusión inteligente de madrugada: ironía lúcida, cercanía y filo, sin postal bohemia."},
