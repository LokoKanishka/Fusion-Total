...
n8n_exec n8n export:workflow --id "$WORKFLOW_ID" --output /tmp/lucy_gateway_src.json >/dev/null
...
n8n_exec n8n import:workflow --input=/tmp/lucy_gateway_patched.json >/dev/null
